...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(190, 15, utf8_decode('REPORTE DE PRODUCTOS CON MÁS STOCK'), 0, 1, 'C'); // Cambiado el título a mayúsculas y el alto de la celda a 15
        
        // Descripción debajo del título
        $this->SetFont('Times', '', 12); // Tamaño de fuente para la descripción
        $this->SetTextColor(0, 0, 0); // Color negro para la descripción
        $this->Cell(50); // Espacio para el logo
        $this->Cell(190, 10, utf8_decode('Este es un reporte detallado de los 10 productos con más stock registrados en el sistema.'), 0, 1, 'C');
...
$query = "SELECT nombre, stock FROM producto ORDER BY stock DESC LIMIT 10";
...
// Crear el gráfico de pastel usando la API de QuickChart
$chartData = [
    "type" => "pie",
    "data" => [
        "labels" => $labels,
    ...
    "options" => [
        "title" => [
            "display" => true,
            "text" => "Top 10 Productos con Más Stock"
        ],
        "legend" => [
            "display" => true,
            "position" => "bottom",
